    ...
    <main>
      ...
      <div className="lg:w-1/3 mt-6 lg:mt-0 lg:ml-6 p-4 bg-white shadow-md rounded-md">
        ...
        <div className="flex flex-col font-semibold">
          <h1 className='justify-around'>Subtotal  <span>Rs. 250,000.00</span></h1>
          <span>Total</span>
          <span>Rs. 250,000.00</span>
        </div>
...
<p>Make your payment directly into our bank account. Please use your Order ID as the payment reference. Your order will not be shipped until the funds have cleared in our account.</p>
        ...
        <div className="mt-6">
          ...
          <button className="w-full bg-blue-500 text-white py-2 rounded-md hover:bg-blue-600 transition mt-8">Place order</button>
        </div>
      </div>
    </div>
    </main>
